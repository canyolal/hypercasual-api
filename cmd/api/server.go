...
func (app *application) serve() error {
	...
	go func() {
		...
		// Call Shutdown() on the server, send on the
		...
		// blocking until the background goroutines have finished. Then return nil on
	...
	// return a http.ErrServerClosed error. So check specifically for this,
	...
	// shutdownError channel. If return value is an error, there was a
